...
const componentSources = [
  ...
  join(distDir, 'components/inputs/input_module.css'),
  join(distDir, 'components/inputs/input-adornment_module.css'),
  join(distDir, 'components/inputs/text-area_module.css'),
  join(distDir, 'components/inputs/label_module.css'),
  join(distDir, 'components/inputs/error-text_module.css'),
  join(distDir, 'components/inputs/help-text_module.css'),
